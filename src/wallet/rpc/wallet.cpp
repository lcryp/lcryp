    ...
    return RPCHelpMan{"getwalletinfo",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::NUM_TIME, "keypoololdest",  true, "the " + UNIX_EPOCH_TIME + " of the oldest pre-generated key in the key pool. Legacy wallets only."},
                        {RPCResult::Type::NUM, "keypoolsize", "how many new keys are pre-generated (only counts external keys)"},
                        {RPCResult::Type::NUM, "keypoolsize_hd_internal",  true, "how many new keys are pre-generated for internal use (used for change outputs, only appears if the wallet is using this feature, otherwise external keys are used)"},
                        {RPCResult::Type::NUM_TIME, "unlocked_until",  true, "the " + UNIX_EPOCH_TIME + " until which the wallet is unlocked for transfers, or 0 if the wallet is locked (only present for passphrase-encrypted wallets)"},
                        {RPCResult::Type::STR_AMOUNT, "paytxfee", "the transaction fee configuration, set in " + CURRENCY_UNIT + "/kvB"},
                        {RPCResult::Type::STR_HEX, "hdseedid",  true, "the Hash160 of the HD seed (only present when HD is enabled)"},
...
static RPCHelpMan loadwallet()
{
    return RPCHelpMan{"loadwallet",
                ...
                "\nNote that all wallet command-line options used when starting lcrypd will be"
    ...
    return RPCHelpMan{"setwalletflag",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::STR, "warnings",  true, "Any warnings associated with the change"},
                    }
                },
                RPCExamples{
    ...
    return RPCHelpMan{"upgradewallet",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::STR, "result",  true, "Description of result, if no error"},
    ...
    [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    for (size_t i = 0; i < txs.size(); ++i) {
        ...
        if (!DecodeHexTx(mtx, txs[i].get_str(),   true,   true)) {
    ...
    return RPCHelpMan{"migratewallet",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::STR, "watchonly_name",  true, "The name of the migrated wallet containing the watchonly scripts"},
                {RPCResult::Type::STR, "solvables_name",  true, "The name of the migrated wallet containing solvable but not watched scripts"},
