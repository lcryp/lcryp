...
static RPCHelpMan estimaterawfee()
{
    return RPCHelpMan{"estimaterawfee",
        ...
        RPCResult{
            ...
            {
                {RPCResult::Type::OBJ, "short",  true, "estimate for short time horizon",
                    {
                        {RPCResult::Type::NUM, "feerate",  true, "estimate fee rate in " + CURRENCY_UNIT + "/kvB"},
                        {RPCResult::Type::NUM, "decay", "exponential decay (per block) for historical moving average of confirmation data"},
                        {RPCResult::Type::NUM, "scale", "The resolution of confirmation targets at this time horizon"},
                        {RPCResult::Type::OBJ, "pass",  true, "information about the lowest range of feerates to succeed in meeting the threshold",
                        {
                        ...
                        {RPCResult::Type::OBJ, "fail",  true, "information about the highest range of feerates to fail to meet the threshold",
                        {
                ...
                {RPCResult::Type::OBJ, "medium",  true, "estimate for medium time horizon",
                {
                    {RPCResult::Type::ELISION, "", ""},
                }},
                {RPCResult::Type::OBJ, "long",  true, "estimate for long time horizon",
                {
                    {RPCResult::Type::ELISION, "", ""},
                }},
            }},
