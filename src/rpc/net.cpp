        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::STR, "addrbind",  true, "(ip:port) Bind address of the connection to the peer"},
                    {RPCResult::Type::STR, "addrlocal",  true, "(ip:port) Local address as reported by the peer"},
                    {RPCResult::Type::STR, "network", "Network (" + Join(GetNetworkNames( true), ", ") + ")"},
                    {RPCResult::Type::NUM, "mapped_as",  true, "The AS in the BGP route to the peer used for diversifying\n"
                    ...
                    {RPCResult::Type::BOOL, "relaytxes",  true, "Whether peer has asked us to relay transactions to it"},
                    ...
                    {RPCResult::Type::NUM, "pingtime",  true, "ping time (if available)"},
                    {RPCResult::Type::NUM, "minping",  true, "minimum observed ping time (if any at all)"},
                    {RPCResult::Type::NUM, "pingwait",  true, "ping wait (if non-zero)"},
                    {RPCResult::Type::NUM, "version", "The peer version, such as 70001"},
                    {RPCResult::Type::STR, "subver", "The string version"},
                    {RPCResult::Type::BOOL, "inbound", "Inbound (true) or Outbound (false)"},
                    {RPCResult::Type::BOOL, "bip152_hb_to", "Whether we selected peer as (compact blocks) high-bandwidth peer"},
                    {RPCResult::Type::BOOL, "bip152_hb_from", "Whether peer selected us as (compact blocks) high-bandwidth peer"},
                    {RPCResult::Type::NUM, "startingheight",  true, "The starting height (block) of the peer"},
                    {RPCResult::Type::NUM, "presynced_headers",  true, "The current height of header pre-synchronization with this peer, or -1 if no low-work sync is in progress"},
                    {RPCResult::Type::NUM, "synced_headers",  true, "The last header we have in common with this peer"},
                    {RPCResult::Type::NUM, "synced_blocks",  true, "The last block we have in common with this peer"},
                    {RPCResult::Type::ARR, "inflight",  true, "",
                    {
                        {RPCResult::Type::NUM, "n", "The heights of blocks we're currently asking from this peer"},
                    }},
                    {RPCResult::Type::BOOL, "addr_relay_enabled",  true, "Whether we participate in address relay with this peer"},
                    {RPCResult::Type::NUM, "addr_processed",  true, "The total number of addresses processed, excluding those dropped due to rate limiting"},
                    {RPCResult::Type::NUM, "addr_rate_limited",  true, "The total number of addresses dropped due to rate limiting"},
                    {RPCResult::Type::ARR, "permissions", "Any special permissions that have been granted to this peer",
                    {
                        {RPCResult::Type::STR, "permission_type", Join(NET_PERMISSIONS_DOC, ",\n") + ".\n"},
                    }},
                    {RPCResult::Type::NUM, "minfeefilter",  true, "The minimum fee rate for transactions this peer accepts"},
...
static RPCHelpMan addconnection()
{
    return RPCHelpMan{"addconnection",
        ...
        RPCExamples{
            HelpExampleCli("addconnection", "\"192.168.0.6:4995\" \"outbound-full-relay\"")
            + HelpExampleRpc("addconnection", "\"192.168.0.6:4995\" \"outbound-full-relay\"")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCHelpMan disconnectnode()
{
    return RPCHelpMan{"disconnectnode",
                ...
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
                    HelpExampleCli("disconnectnode", "\"192.168.0.6:4995\"")
            + HelpExampleCli("disconnectnode", "\"\" 1")
            + HelpExampleRpc("disconnectnode", "\"192.168.0.6:4995\"")
                    ...
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::ARR, "addresses", "Only when connected = true",
                            {
                                {RPCResult::Type::OBJ, "", "",
                                {
                                    {RPCResult::Type::STR, "address", "The lcryp server IP and port we're connected to"},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    const std::vector<CAddress> vAddr{connman.GetAddresses(count,  0, network)};
    UniValue ret(UniValue::VARR);
...
static RPCHelpMan addpeeraddress()
{
    return RPCHelpMan{"addpeeraddress",
        ...
        RPCExamples{
            HelpExampleCli("addpeeraddress", "\"1.2.3.4\" 4995 true")
    + HelpExampleRpc("addpeeraddress", "\"1.2.3.4\", 4995, true")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    NodeContext& node = EnsureAnyNodeContext(request.context);
