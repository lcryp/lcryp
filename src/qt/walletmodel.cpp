...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction &transaction, const CCoinControl& coinControl)
{
    ...
    }
    {
        ...
        const auto& res = m_wallet->createTransaction(vecSend, coinControl, !wallet().privateKeysDisabled()  , nChangePosRet, nFeeRequired);
...
bool WalletModel::bumpFee(uint256 hash, uint256& new_hash)
{
    ...
    questionString.append(LcRypUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), old_fee));
    questionString.append("</td></tr><tr><td>");
    questionString.append(tr("Increase:"));
    questionString.append("</td><td>");
    questionString.append(LcRypUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), new_fee - old_fee));
    questionString.append("</td></tr><tr><td>");
    questionString.append(tr("New fee:"));
    questionString.append("</td><td>");
    questionString.append(LcRypUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), new_fee));
    ...
    if (retval == QMessageBox::Save) {
        ...
        bool complete = false;
        const TransactionError err = wallet().fillPSBT(SIGHASH_ALL, false  , true  , nullptr, psbtx, complete);
